...
public class RoyaltiesReport extends Composite implements
   ...
   public RoyaltiesReport() {
      ...
      Scheduler.get().scheduleDeferred(new ScheduledCommand() {
         @Override
         public void execute() {
             reportScrollPanel.setHeight(""
                     + (RoyaltiesReport.this.getOffsetHeight()-200) + "px");
                  ...
                  companyListBox
                        .addValueChangeHandler(new ValueChangeHandler<CompanyDTO>() {
                           ...
                           public void onValueChange(
                                 ValueChangeEvent<CompanyDTO> event) {
   ...
   private void getReport() {
      ...
      startMonthPeriodDto
            .setMonth(startMonthPeriodListBox.getSelectedIndex() + 1);
      startMonthPeriodDto.setYear(startYearPeriodListBox.getSelectedIndex()
            + STARTING_YEAR);
      ...
      endMonthPeriodDto.setYear(endYearPeriodListBox.getSelectedIndex()
            + STARTING_YEAR);

      royaltyReportService.getCompanyReport(currentCompany,
            startMonthPeriodDto, endMonthPeriodDto,
            new AsyncCallback<List<RoyaltyReportLine>>() {
                  ...
                  if (result != null && result.size()>0) {
                     ...
                     for (RoyaltyReportLine sales : result) {
                        if (lineIdx == 0) {
                           ...
                           royaltyReport.getCellFormatter().setAlignment(lineIdx,
                        ...
                        if (currentPeriod.getId() != sales.getPeriod().getId()) {
                           ...
                           lineIdx += 1;
                           royaltyReport.setText(lineIdx, 0, "");
                           royaltyReport.getCellFormatter().setHeight(lineIdx, 0, "5px");                           lineIdx += 1;
                           royaltyReport.setText(
                                 lineIdx,
                                 0,
                                 "Total Royalties for period " + currentPeriod
                                       + " = " + periodRoyalty + " "
                                       + sales.getReferenceCurrency());
                           currentPeriod = sales.getPeriod();
                           royaltyReport.getCellFormatter().setHeight(lineIdx, 0, "10px");
                           lineIdx += 1;
                           royaltyReport.setText(lineIdx, 0, "");
                        ...
                        royaltyReport.setText(lineIdx, 0, sales
                              .getApplication().getName());
                        royaltyReport.setText(lineIdx, 1, sales.getZone()
                              .getName());
                        royaltyReport.setText(lineIdx, 2,
                              String.valueOf(sales.getSalesNumber()));
                        royaltyReport.getCellFormatter().setAlignment(lineIdx,
                              2, HasHorizontalAlignment.ALIGN_RIGHT,
                              HasVerticalAlignment.ALIGN_MIDDLE);
                        royaltyReport.setText(lineIdx, 3,
                              (sales.getOriginalCurrencyAmount().setScale(2, RoundingMode.HALF_UP).toString()
                                    + " " + sales.getOriginalCurrency()));
                        royaltyReport.getCellFormatter().setAlignment(lineIdx,
                              3, HasHorizontalAlignment.ALIGN_RIGHT,
                              HasVerticalAlignment.ALIGN_MIDDLE);
                        royaltyReport.setText(lineIdx, 4, (sales
                              .getOriginalCurrencyTotalAmount().setScale(2, RoundingMode.HALF_UP).toString()
                              + " " + sales.getOriginalCurrency()));
                        royaltyReport.getCellFormatter().setAlignment(lineIdx,
                              4, HasHorizontalAlignment.ALIGN_RIGHT,
                              HasVerticalAlignment.ALIGN_MIDDLE);
                        royaltyReport
                              .setText(
                                    lineIdx,
                                    5,
                                    (sales.getReferenceCurrencyProceedsAfterTaxTotalAmount().setScale(2, RoundingMode.HALF_UP)
                                          .toString()
                                          + " " + sales.getReferenceCurrency()));
                        royaltyReport.getCellFormatter().setAlignment(lineIdx,
                              5, HasHorizontalAlignment.ALIGN_RIGHT,
                              HasVerticalAlignment.ALIGN_MIDDLE);
                        royaltyReport
                              .setText(
                                    lineIdx,
                                    6,
                                    (sales.getReferenceCurrencyCompanyRoyaltiesTotalAmount().setScale(2, RoundingMode.HALF_UP)
                                          .toString()
                                          + " " + sales.getReferenceCurrency()));
                        royaltyReport.getCellFormatter().setAlignment(lineIdx,
                              6, HasHorizontalAlignment.ALIGN_RIGHT,
                              HasVerticalAlignment.ALIGN_MIDDLE);
                        periodRoyalty = periodRoyalty.add(sales
                              .getReferenceCurrencyCompanyRoyaltiesTotalAmount().setScale(2, RoundingMode.HALF_UP));
                     ...
                     royaltyReport.setText(lineIdx, 0,
                           "Total Royalties for period " + currentPeriod
                                 + " = " + periodRoyalty.setScale(2, RoundingMode.HALF_UP));
                     lineIdx += 1;
                     royaltyReport.setText(lineIdx, 0, "");                     royaltyReport.setText(lineIdx, 0,
                           "Grand Total Royalties  = " + totalRoyalty.setScale(2, RoundingMode.HALF_UP));
                     royaltyReport.getCellFormatter().setHeight(lineIdx, 0, "10px");
                     ...
                     royaltyReport.setText(0, 0,
                           "No data found for current selection");
                     royaltyReport.getCellFormatter().setAlignment(0,
               ...
               private void showHeaders(int lineIdx) {
                  ...
                  royaltyReport
                        .setText(
                              lineIdx,
                              5,
                              "Ref. currency proceeds after tax");
                  royaltyReport.getCellFormatter().setAlignment(lineIdx,
                        5, HasHorizontalAlignment.ALIGN_RIGHT,
                        HasVerticalAlignment.ALIGN_MIDDLE);
                  royaltyReport
