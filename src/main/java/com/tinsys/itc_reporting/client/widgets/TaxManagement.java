         ...
         public void onSelectionChange(SelectionChangeEvent event) {
            if ((editionInProgress && selectionModel.getSelectedObject() != selectedTax)
               ...
               if (selectedTax != null) {
                  ...
                  taxPeriodStartDateDateBox.setValue(selectedTax.getPeriod()
                        .getStartDate());
                  taxPeriodStopDateDateBox.setValue(selectedTax.getPeriod()
                        .getStopDate());
                  cancelUpdateTax.setVisible(true);
      ...
      for (TaxDTO taxDTO : taxList) {
         ...
         if (selectedTax == null) { // new Tax
            ...
            if (existingStartDate<newStartDate && existingStopDate<newStartDate){
              ...
              if (existingStartDate>newStopDate && existingStopDate>newStopDate){
            ...
            if (errors.size() == 0 && existingStopDate == Long.MAX_VALUE){
