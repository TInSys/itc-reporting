...
public class CompanyManagement extends Composite implements WidgetSwitchManagement {
  ...
  final Column<CompanyDTO, String> companyNameColumn = new Column<CompanyDTO, String>(new ClickableTextCell()) {
  ...
  final Column<CompanyDTO, String> companyCurrencyISOColumn = new Column<CompanyDTO, String>(new ClickableTextCell()) {
  ...
  public CompanyManagement() {
    ...
    companyCurrencyISOTextBox.addValueChangeHandler(new ValueChangeHandler<String>() {
      public void onValueChange(ValueChangeEvent<String> arg0) {
        editionInProgress = true;
        cancelUpdateCompany.setVisible(true);
      }
  ...
  private Handler getSelectionChangeHandler() {
    return new SelectionChangeEvent.Handler() {
      ...
      public void onSelectionChange(SelectionChangeEvent event) {
        if ((editionInProgress && selectionModel.getSelectedObject() != selectedCompany) || reverseSelection) {
  ...
  void handleClickSave(ClickEvent e) {
    if (companyNameTextBox.getText().length() > 0 && companyCurrencyISOTextBox.getText().length() > 0) {
      if (selectedCompany == null) {
