...
public class FXRateManagementByZone extends Composite implements
   ...
   final Column<FXRateDTO, String> fxRateCurrencyColumn = new Column<FXRateDTO, String>(
         new ClickableTextCell()) {
            ...
            if (fxRateDTO != selectedFXRate) {
               if (fxRateDTO.getPeriod().getMonth() == Integer
                     .parseInt(monthPeriod.getValue(monthPeriod
                           .getSelectedIndex()))
                     && fxRateDTO.getPeriod().getYear() == Integer
                           .parseInt(yearPeriod.getValue(yearPeriod
                                 .getSelectedIndex()))) {
