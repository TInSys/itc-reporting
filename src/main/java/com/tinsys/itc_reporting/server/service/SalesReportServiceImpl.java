...
public class SalesReportServiceImpl implements SalesReportService {
    ...
    public List<MonthReportSummary> getMonthlyReport(FiscalPeriodDTO period) {
        ...
        for (Sales sale : sales) {
            ...
            if (application != currentApplication && applicationSumary != null) {
            ...
            applicationSumary.setReferenceCurrency(preferences.getReferenceCurrency());
            applicationSumary.setReferenceCurrencyAmount(applicationSumary.getReferenceCurrencyAmount().add(sale.getTotalPrice().multiply(changeRate)));
