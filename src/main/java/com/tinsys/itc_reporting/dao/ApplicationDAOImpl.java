...
public class ApplicationDAOImpl implements ApplicationDAO {
  ...
  public ArrayList<ApplicationDTO> getAllApplications() {
    ...
    ArrayList<Application> applicationList = (ArrayList<Application>) factory.getCurrentSession().createCriteria(Application.class).addOrder(Order.asc("vendorID")).list();
  ...
  public ApplicationDTO updateApplication(ApplicationDTO aApplication) {
    Application application = (Application) factory.getCurrentSession().get(Application.class, aApplication.getId());
    application.setVendorID(aApplication.getVendorID());
    application.setName(aApplication.getName());
