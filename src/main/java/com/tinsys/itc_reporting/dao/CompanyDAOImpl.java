...
public class CompanyDAOImpl implements CompanyDAO {
    ...
    public ArrayList<CompanyDTO> getAllCompanies() {
        ...
        ArrayList<Company> companyList = (ArrayList<Company>) factory
                .getCurrentSession().createCriteria(Company.class)
    ...
    public CompanyDTO updateCompany(CompanyDTO aCompany) {
        Company company = (Company) factory.getCurrentSession().get(Company.class,
                aCompany.getId());
        company.setName(aCompany.getName());
        company.setCurrencyISO(aCompany.getCurrencyISO());
