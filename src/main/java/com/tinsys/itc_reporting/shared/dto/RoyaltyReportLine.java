...
public class RoyaltyReportLine implements Serializable {
    ...
    public void setOriginalCurrencyTotalAmount(
            BigDecimal originalCurrencyTotalAmount) {
    ...
    public void setReferenceCurrencyTotalAmount(
            BigDecimal referenceCurrencyTotalAmount) {
    ...
    public void setReferenceCurrencyProceedsAfterTaxTotalAmount(
            BigDecimal referenceCurrencyProceedsAfterTaxTotalAmount) {
    ...
    public void setReferenceCurrencyCompanyRoyaltiesTotalAmount(
            BigDecimal referenceCurrencyCompanyRoyaltiesTotalAmount) {
